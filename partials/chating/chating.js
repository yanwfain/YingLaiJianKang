...
let pageConfig = {
  ...
  switchToMyTab() {
    wx.switchTab({
      url: '/pages//pages/pages/setting/setting',
    })
  },
  /**
   * 切换到对方介绍页
  ...
  //     wx.navigateTo({
  //       url: '/pages/../partials/advancedGroupMemberCard/advancedGroupMemberCard?account=' + data.target.dataset.account + '&teamId=' + this.data.chatTo
  //     })
  //   }   
  // },
  /**
  ...
  forwardMessage(paramObj) {
    ...
    wx.redirectTo({
      url: '/pages/forwardContact/forwardContact?data=' + str,
    })
  },
  /**
   * 撤回消息
