...
App( Provider(store)({
  onLaunch: function () {
    const manager = requirePlugin("ICDeviceManager");
    this.manager = manager;
    this.ICDeviceManager = new manager.ICDeviceManager();
    this.ICDeviceManager.init(function (isInit) {
    })
    // setBleStateCallback(function (bleState) { })
    // 展示本地存储能力
...
//     this.globalData.startDate = Y + '-' + M + '-' + D
//     this.date = Y + '-' + M + '-' + D
//     this.hour = H + ':'+ S
//     this.time = H + ':'+ S
//     this.startYear = Y
//     this.globalData.startTinmesr = H + ':' + S
