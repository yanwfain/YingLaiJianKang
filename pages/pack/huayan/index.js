...
Page({
  ...
  data: {
    ...
    imgboxs14: [],
    imgboxs15: [],
    multiArray: [['糖化血红蛋白'], ['6.3%', '6.4%', '6.5%', '6.6%', '6.7%']],
    multiArray1: [['糖化血清蛋白','糖化白蛋白'], ['1.4 mmol/L', '1.5 mmol/L', '1.6 mmol/L', '1.7 mmol/L', '1.8 mmol/L']],
  ...
  onLoad: function (options) {
    ...
    //         that.setData({
    //           multiIndex:res.data.saccharifyVal,
    //           multiIndex1:res.data.serumVal
    ...
    //         imgboxs: JSON.parse(res.data.routineBlood),
    //         imgboxs1: JSON.parse(res.data.saccharify),
    //         imgboxs15: JSON.parse(res.data.urinalysis),
    //         imgboxs12: JSON.parse(res.data.serumAlbumin),
    //         imgboxs13: JSON.parse(res.data.islets),
    //         imgboxs14: JSON.parse(res.data.cReactive),
  ...
  bindMultiPickerChange: function (e) {
    ...
    console.log(this.data.multiArray[1][0])
  },
  ...
  xiapageFn:function(e){
    ...
    // imgboxs15: [],
    if(!this.data.type){
      var url = app.globalData.url + '/api/saveTaskBill';
    }
    if(this.data.type){
      var url = app.globalData.url + '/api/updateBillByUserId';
    }
    
    var data = {
      id:this.data.id?this.data.id:'',
      type:this.data.type?this.data.type:'',
      testDate:this.data.date,
      saccharifyVal:JSON.stringify(this.data.multiIndex),
      serumVal:JSON.stringify(this.data.multiIndex1),
      biochemistry:JSON.stringify(this.data.imgbox),
      routineBlood:JSON.stringify(this.data.imgboxs),
      saccharify:JSON.stringify(this.data.imgboxs1),
      serumAlbumin:JSON.stringify(this.data.imgboxs12),
      islets:JSON.stringify(this.data.imgboxs13),
      cReactive:JSON.stringify(this.data.imgboxs14),
      urinalysis:JSON.stringify(this.data.imgboxs15),
