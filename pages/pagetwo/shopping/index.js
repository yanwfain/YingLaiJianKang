...
Page({
  ...
  onLoad: function (options) {
    ...
    var that = this
    var url = app.globalData.url + '/api/shop/index';
    var data = {
  ...
  zhuanquFn:function(e){
    wx.navigateTo({
      url: '/pages/pagetwo/zhuanqu/index?id=' + e.currentTarget.dataset.id,
    })
  },
  swiperChange (e){
    this.setData({
  ...
  classcity:function(e){
    wx.navigateTo({
      url: '/pages/pack/classcity/index',
    })
  },
