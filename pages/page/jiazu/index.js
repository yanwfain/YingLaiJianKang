...
Page({
  ...
  submiiti:function(e){
    ...
    var url = app.globalData.url + '/api/updateUserCamperFamily';
    var data = {
      userId:app.globalData.user_id,
      diabetes:JSON.stringify(that.data.listWulist) ,
  ...
  baocunsx: function (e) {
    ...
    var url = app.globalData.url + '/joinCamp/saveFamily';
    var data = {
  ...
  xiapageFn: function (e) {
    ...
    app.wxRequest('POST', url, data, (res) => {
      ...
      if (res.success) {
        wx.navigateTo({
          url: '/pages/pagetwo/zhongyi/index',
        })
      } else {
        wx.showToast({
          title: res.msg,
  ...
  onShow: function () {
    var that = this
		...
		var url = app.globalData.url + '/camper/getFamilyByUser';
    var data = {
      user_id:app.globalData.user_id,
    }
    app.wxRequest('POST', url, data, (res) => {
      ...
      if (res.success&&res.data) {
        that.setData({
          jid:res.data.id,
          listWulist:JSON.parse(res.data.diabetes),
          isshowtxt:res.data.other?true:false,
          textart:res.data.other?res.data.other:'',
        
        })
        var dv1 =JSON.parse(res.data.diabetes) 
